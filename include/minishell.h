...
t_token						*process_lexer(char *input,
...
void						ft_print_error(char *prefix, char *dynamic_part,
								char *suffix);
...
char						*lexer_collect_subword(t_lexer *lexer,
								t_shell_context **shell_ctx);
char						*lexer_collect_quoted(t_lexer *lexer,
								char quote_type, t_shell_context **shell_ctx);
