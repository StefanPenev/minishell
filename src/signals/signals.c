...
/*   Updated: 2024/12/08 22:57:11 by stefan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * Calls the `sig_init` function to set up the signal handlers and
 * the `suppress_output` function to suppress output as part of shell setup.
 */
